...
const Card = ({ photo, title = "Card Title", description = "This is a placeholder description for the card. Add your own content here." }) => {
    return (
        ...
        >
            <img className="card-img-top" src={photo} alt={title} style={{ height: '200px', objectFit: 'cover' }} />
